				...
				<div class="input-group">
					<div class="form-group col-lg-6">
						...
						<?php $region_array = array();
							...
							echo form_dropdown(['id' => 'FKRegionID','name' => 'FKRegionID', 'class' => 'browser-default custom-select','autocomplete' => 'off','onChange' => 'changecat(this.value);'],$region_array,$User['FKRegionID']); ?>
						<span><?php echo form_error('FKRegionID') ?></span>
					</div>
					<div class="form-group col-lg-6">
						<label>Field/World Area<i class="text-warning">*</i></label>
						<?php echo form_dropdown(['id' => 'FKFieldID','name' => 'FKFieldID', 'class' => 'browser-default custom-select','autocomplete' => 'off'],$User['FKFieldID']); ?>
				...
				<div class="input-group">
					<div class="form-group col-lg-6">
						...
						<?php $country_array = array();
							...
							echo form_dropdown(['id' => 'Country','name' => 'FKCountryID', 'class' => 'browser-default custom-select','autocomplete' => 'off'],$country_array,$User['FKCountryID']); ?>
					...
					<div class="form-group col-lg-6">
						...
						<?php $district_array = array();
							...
							echo form_dropdown(['id' => 'FKDistrictID','name' => 'FKDistrictID', 'class' => 'browser-default custom-select','autocomplete' => 'off'],$district_array,$User['FKDistrictID']); ?>
